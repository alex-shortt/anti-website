...
var initAnti3D = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var config, colorConfig, Planet, Particle, canvas, ctx, w, h, hue, particles, spikeLength, planets, A, B, a, b, tick, setup, reset, mousemove, draw, clear, drawText, updatePlanets, updateParticles;
          ...
          case 0:
            ...
            mousemove = function mousemove(event) {
              ...
              if ($(window).width < 800) {
                ...
                planets[0].pos.y = y - ($(".socials-anti3d").height() - $("#anti3d").height()) / 2;
              }
            };
            ...
            reset = function reset() {
              ...
              h = canvas.height = Math.floor($(".socials-left-instafeed").height());
              /*
